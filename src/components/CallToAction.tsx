...
const CallToAction = () => {
  ...
  return <section className="py-16 bg-mica-gray-5/30">
      <div className="container px-4 mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-mica-gray-2 text-lg mb-8 max-w-2xl mx-auto">Únete a miles de asesores inmobiliarios que ya confían en nosotros para proteger las propiedades de sus clientes.</p>
