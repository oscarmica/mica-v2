...
const steps = [
  ...
  }, 
  {
    ...
    details: [
      'Protección básica para tranquilidad esencial',
      'Protección plus con coberturas adicionales',
      'Protección total para máxima seguridad',
      'Planes personalizados para propiedades especiales'
    ]
  }, 
  {
    ...
    details: [
      'Contratos personalizados según tus necesidades',
  ...
  }, 
  {
    ...
    details: [
      'Cobros automáticos en fechas programadas',
      'Notificaciones de pago para inquilinos',
      'Transferencias seguras a tu cuenta bancaria',
      'Seguimiento de pagos y reportes mensuales'
    ]
  }
];
