...
const RentInput: React.FC<RentInputProps> = ({
  ...
  return (
    <motion.div 
      className="mb-4 bg-white rounded-xl p-4 shadow-md border border-slate-100"
    ...
    >
      ...
      <div className="relative group">
        ...
        <Input 
          ...
          className="pl-8 pr-16 text-base py-5 h-auto border border-slate-200 focus-visible:border-mica-green/80 focus-visible:ring-0 focus-visible:ring-offset-0 transition-all duration-200 shadow-sm rounded-lg" 
          min="1000" 
          placeholder="10,000" 
        />
      ...
      <div className="mt-2 text-center">
        <div className="inline-flex items-center bg-amber-50 text-amber-700 px-2 py-1 rounded-lg text-xs">
          <span className="font-medium">Consejo:</span>
          <span className="ml-1">Precio mínimo según plan</span>
        </div>
      </div>
    </motion.div>
  );
