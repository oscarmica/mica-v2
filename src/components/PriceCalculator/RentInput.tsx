    ...
    >
      ...
      <div className="relative group">
        ...
        <Input
          ...
          className="pl-8 text-lg py-6 h-auto border-2 border-slate-200 focus-visible:border-mica-green/80 focus-visible:ring-0 focus-visible:ring-offset-0 transition-all duration-200 shadow-sm"
          min="1000"
      ...
      <p className="text-xs text-mica-gray-3 mt-2 ml-1">Mínimo recomendado: $1,000 MXN</p>
    </motion.div>
  );
};
