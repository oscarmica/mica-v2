...
const PriceCalculator = () => {
  ...
  const filteredPlans = protectionPlans.filter(plan => plan.propertyTypes.includes(propertyType));
        ...
        delay: 0.2
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 md:gap-4 relative">
            ...
            <div className="lg:col-span-8">
              <PlanCardGrid protectionPlans={filteredPlans} prices={prices} isMonthly={isMonthly} hoveredPlan={hoveredPlan} setHoveredPlan={setHoveredPlan} formatCurrency={formatCurrency} />
            </div>
          </div>
        </motion.div>
      </div>
