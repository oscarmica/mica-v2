      ...
      <div className="container px-4 mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-4 relative inline-block">
            <span className="relative z-10">Pago garantizado al propietario</span>
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            <span className="font-semibold text-gray-800">No más rentas impagadas. No más incertidumbre financiera.</span> Con mica, los propietarios reciben su renta puntualmente todos los meses, <span className="underline decoration-mica-green/30 decoration-2">incluso si el inquilino se atrasa o deja de pagar.</span>
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          className="mt-12 bg-gradient-to-r from-mica-green/10 to-blue-50 p-6 rounded-xl max-w-3xl mx-auto text-center"
        >
          <p className="text-lg font-medium text-gray-800">
            "Garantizamos el pago puntual de la renta al propietario, independientemente de la conducta del inquilino."
          </p>
        </motion.div>
      </div>
    </section>
