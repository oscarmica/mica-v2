      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className={cn(
                "bg-white p-8 rounded-xl border border-pink-100 shadow-sm",
                "hover:border-pink-200 hover:shadow-md transition-all duration-300 h-full"
              )}>
                ...
                <div className="mt-auto pt-4 border-t border-pink-50 flex items-center">
                  <img 
                    ...
                    className="h-12 w-12 rounded-full object-cover mr-4 border-2 border-white ring-2 ring-pink-50"
                    loading="lazy"
                  />
                  <div>
        ...
        >
          <div className="inline-flex items-center bg-white px-6 py-3 rounded-full shadow-sm border border-pink-100">
            <Star className="h-5 w-5 fill-amber-400 text-amber-400 mr-2" />
            <span className="font-medium">4.9 de 5 estrellas</span>
            <span className="mx-2 text-slate-300">|</span>
            <span className="text-slate-600">Basado en más de 1,000 reseñas</span>
          </div>
        </motion.div>
      </div>
    </section>
